...
const actions = {
  async getStatus({ commit }) {
    const status = await API.get(
      `${import.meta.env.VITE_MIDDLEWARE_API_URL}/v1/bitcoind/info/status`
    );
  ...
  async getAddresses({ commit }) {
    const addresses = await API.get(
      `${import.meta.env.VITE_MIDDLEWARE_API_URL}/v1/bitcoind/info/addresses`
    );
  ...
  async getP2PInfo({ commit }) {
    const p2pInfo = await API.get(
      `${import.meta.env.VITE_MANAGER_API_URL}/v1/system/bitcoin-p2p-connection-details`
    );
  ...
  async getElectrumInfo({ commit }) {
    const electrumInfo = await API.get(
      `${import.meta.env.VITE_MANAGER_API_URL}/v1/system/electrum-connection-details`
    );
  ...
  async getRpcInfo({ commit }) {
    const rpcInfo = await API.get(
      `${import.meta.env.VITE_MANAGER_API_URL}/v1/system/bitcoin-rpc-connection-details`
    );
  ...
  async getSync({ commit }) {
    const sync = await API.get(
      `${import.meta.env.VITE_MIDDLEWARE_API_URL}/v1/bitcoind/info/sync`
    );
  ...
  async getBlocks({ commit, state, dispatch }) {
    ...
    const latestThreeBlocks = await API.get(
      `${import.meta.env.VITE_MIDDLEWARE_API_URL}/v1/bitcoind/info/blocks?from=${
        currentBlock - 2
      }&to=${currentBlock}`
    );
  ...
  async getVersion({ commit }) {
    const version = await API.get(
      `${import.meta.env.VITE_MIDDLEWARE_API_URL}/v1/bitcoind/info/version`
    );
  ...
  async getPeers({ commit }) {
    const peers = await API.get(
      `${import.meta.env.VITE_MIDDLEWARE_API_URL}/v1/bitcoind/info/connections`
    );
  ...
  async getStats({ commit }) {
    const stats = await API.get(
      `${import.meta.env.VITE_MIDDLEWARE_API_URL}/v1/bitcoind/info/stats`
    );
  ...
  async getBalance({ commit }) {
    const balance = await API.get(
      `${import.meta.env.VITE_MIDDLEWARE_API_URL}/v1/lnd/wallet/btc`
    );
  ...
  async getTransactions({ commit }) {
    const transactions = await API.get(
      `${import.meta.env.VITE_MIDDLEWARE_API_URL}/v1/lnd/transaction`
    );
  ...
  async getPrice({ commit }) {
    const price = await API.get(
      `${import.meta.env.VITE_MANAGER_API_URL}/v1/external/price`
    );
  ...
  async getDepositAddress({ commit }) {
    const { address } = await API.get(
      `${import.meta.env.VITE_MIDDLEWARE_API_URL}/v1/lnd/address`
    );
  ...
  async getFees({ commit }, { address, confTarget, amt, sweep }) {
    const fees = await API.get(
      `${import.meta.env.VITE_MIDDLEWARE_API_URL}/v1/lnd/transaction/estimateFee?address=${address}&confTarget=${confTarget}&amt=${amt}&sweep=${sweep}`
    );
